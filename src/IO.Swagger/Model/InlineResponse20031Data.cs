...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20031Data :  IEquatable<InlineResponse20031Data>, IValidatableObject
    {
        ...
        public InlineResponse20031Data(RepairTransaction transaction = default(RepairTransaction))
        {
            // to ensure "transaction" is required (not null)
            if (transaction == null)
            {
                throw new InvalidDataException("transaction is a required property for InlineResponse20031Data and cannot be null");
            }
            else
            {
