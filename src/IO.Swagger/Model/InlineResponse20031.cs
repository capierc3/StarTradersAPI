...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20031 :  IEquatable<InlineResponse20031>, IValidatableObject
    {
        ...
        public InlineResponse20031(InlineResponse20031Data data = default(InlineResponse20031Data))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20031 and cannot be null");
            }
            else
            {
                this.Data = data;
