...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20022Data :  IEquatable<InlineResponse20022Data>, IValidatableObject
    {
        ...
        public InlineResponse20022Data(ShipCargo cargo = default(ShipCargo))
        {
            // to ensure "cargo" is required (not null)
            if (cargo == null)
            {
                throw new InvalidDataException("cargo is a required property for InlineResponse20022Data and cannot be null");
            }
            else
            {
                this.Cargo = cargo;
