...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(List<Waypoint> data = default(List<Waypoint>), Meta meta = default(Meta))
        {
            ...
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for InlineResponse2003 and cannot be null");
            }
            else
            {
                this.Meta = meta;
