...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20030Data :  IEquatable<InlineResponse20030Data>, IValidatableObject
    {
        ...
        public InlineResponse20030Data(Agent agent = default(Agent), ScrapTransaction transaction = default(ScrapTransaction))
        {
            // to ensure "agent" is required (not null)
            if (agent == null)
            {
                throw new InvalidDataException("agent is a required property for InlineResponse20030Data and cannot be null");
            }
            else
            {
                this.Agent = agent;
            ...
            if (transaction == null)
            {
                throw new InvalidDataException("transaction is a required property for InlineResponse20030Data and cannot be null");
            }
            else
            {
