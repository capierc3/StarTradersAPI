...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2011 :  IEquatable<InlineResponse2011>, IValidatableObject
    {
        ...
        public InlineResponse2011(InlineResponse2011Data data = default(InlineResponse2011Data))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse2011 and cannot be null");
            }
            else
            {
                this.Data = data;
