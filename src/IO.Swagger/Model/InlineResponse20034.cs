...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20034 :  IEquatable<InlineResponse20034>, IValidatableObject
    {
        ...
        public InlineResponse20034(List<ShipModule> data = default(List<ShipModule>))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20034 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public List<ShipModule> Data { get; set; }
