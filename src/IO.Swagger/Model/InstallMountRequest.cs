...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InstallMountRequest :  IEquatable<InstallMountRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public InstallMountRequest(string symbol = default(string))
        {
            ...
            if (symbol == null)
            {
                throw new InvalidDataException("symbol is a required property for InstallMountRequest and cannot be null");
            }
            else
            {
                this.Symbol = symbol;
