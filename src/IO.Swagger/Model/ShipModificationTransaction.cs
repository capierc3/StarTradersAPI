...
namespace IO.Swagger.Model
{
        ...
        public partial class ShipModificationTransaction :  IEquatable<ShipModificationTransaction>, IValidatableObject
    {
        ...
        public ShipModificationTransaction(string waypointSymbol = default(string), string shipSymbol = default(string), string tradeSymbol = default(string), int? totalPrice = default(int?), DateTime? timestamp = default(DateTime?))
        {
            ...
            {
                throw new InvalidDataException("waypointSymbol is a required property for ShipModificationTransaction and cannot be null");
            }
            else
            {
            ...
            if (shipSymbol == null)
            {
                throw new InvalidDataException("shipSymbol is a required property for ShipModificationTransaction and cannot be null");
            }
            else
            {
            ...
            if (tradeSymbol == null)
            {
                throw new InvalidDataException("tradeSymbol is a required property for ShipModificationTransaction and cannot be null");
            }
            else
            {
            ...
            if (totalPrice == null)
            {
                throw new InvalidDataException("totalPrice is a required property for ShipModificationTransaction and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for ShipModificationTransaction and cannot be null");
            }
            else
            {
