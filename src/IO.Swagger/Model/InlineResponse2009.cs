...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(List<Faction> data = default(List<Faction>), Meta meta = default(Meta))
        {
            ...
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for InlineResponse2009 and cannot be null");
            }
            else
            {
                this.Meta = meta;
