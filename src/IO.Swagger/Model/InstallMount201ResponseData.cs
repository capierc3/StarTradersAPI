...
namespace IO.Swagger.Model
{
        ...
        public partial class InstallMount201ResponseData :  IEquatable<InstallMount201ResponseData>, IValidatableObject
    {
        ...
        public InstallMount201ResponseData(Agent agent = default(Agent), List<ShipMount> mounts = default(List<ShipMount>), ShipCargo cargo = default(ShipCargo), ShipModificationTransaction transaction = default(ShipModificationTransaction))
        {
            // to ensure "agent" is required (not null)
            if (agent == null)
            {
                throw new InvalidDataException("agent is a required property for InstallMount201ResponseData and cannot be null");
            }
            else
            {
                this.Agent = agent;
            ...
            if (mounts == null)
            {
                throw new InvalidDataException("mounts is a required property for InstallMount201ResponseData and cannot be null");
            }
            else
            {
                this.Mounts = mounts;
            ...
            if (cargo == null)
            {
                throw new InvalidDataException("cargo is a required property for InstallMount201ResponseData and cannot be null");
            }
            else
            {
                this.Cargo = cargo;
            ...
            if (transaction == null)
            {
                throw new InvalidDataException("transaction is a required property for InstallMount201ResponseData and cannot be null");
            }
            else
            {
