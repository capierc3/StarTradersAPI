...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ShipRefine201ResponseData :  IEquatable<ShipRefine201ResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipRefine201ResponseData" /> class.
        /// </summary>
        ...
        public ShipRefine201ResponseData(ShipCargo cargo = default(ShipCargo), Cooldown cooldown = default(Cooldown), List<ShipRefine201ResponseDataProduced> produced = default(List<ShipRefine201ResponseDataProduced>), List<ShipRefine201ResponseDataProduced> consumed = default(List<ShipRefine201ResponseDataProduced>))
        {
            // to ensure "cargo" is required (not null)
            if (cargo == null)
            {
                throw new InvalidDataException("cargo is a required property for ShipRefine201ResponseData and cannot be null");
            }
            else
            {
                this.Cargo = cargo;
            ...
            if (cooldown == null)
            {
                throw new InvalidDataException("cooldown is a required property for ShipRefine201ResponseData and cannot be null");
            }
            else
            {
            ...
            if (produced == null)
            {
                throw new InvalidDataException("produced is a required property for ShipRefine201ResponseData and cannot be null");
            }
            else
            {
            ...
            if (consumed == null)
            {
                throw new InvalidDataException("consumed is a required property for ShipRefine201ResponseData and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="produced", EmitDefaultValue=false)]
        public List<ShipRefine201ResponseDataProduced> Produced { get; set; }
        ...
        public List<ShipRefine201ResponseDataProduced> Consumed { get; set; }
        ...
        {
            return this.Equals(input as ShipRefine201ResponseData);
        }

        /// <summary>
        /// Returns true if ShipRefine201ResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipRefine201ResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipRefine201ResponseData input)
        {
            if (input == null)
                return false;
