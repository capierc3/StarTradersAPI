...
namespace IO.Swagger.Model
{
        ...
        public partial class SellCargoRequest :  IEquatable<SellCargoRequest>, IValidatableObject
    {
        ...
        public SellCargoRequest(TradeSymbol symbol = default(TradeSymbol), int? units = default(int?))
        {
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new InvalidDataException("symbol is a required property for SellCargoRequest and cannot be null");
            }
            else
            {
                this.Symbol = symbol;
            ...
            if (units == null)
            {
                throw new InvalidDataException("units is a required property for SellCargoRequest and cannot be null");
            }
            else
            {
                this.Units = units;
