...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(List<StarSystem> data = default(List<StarSystem>), Meta meta = default(Meta))
        {
            ...
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<StarSystem> Data { get; set; }
