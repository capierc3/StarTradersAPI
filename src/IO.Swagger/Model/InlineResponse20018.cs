...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20018 :  IEquatable<InlineResponse20018>, IValidatableObject
    {
        ...
        public InlineResponse20018(List<Ship> data = default(List<Ship>), Meta meta = default(Meta))
        {
            ...
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for InlineResponse20018 and cannot be null");
            }
            else
            {
                this.Meta = meta;
