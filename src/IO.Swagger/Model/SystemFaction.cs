...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SystemFaction :  IEquatable<SystemFaction>, IValidatableObject
    {
        /// <summary>
        ...
        public SystemFaction(FactionSymbol symbol = default(FactionSymbol))
        {
            ...
            if (symbol == null)
            {
                throw new InvalidDataException("symbol is a required property for SystemFaction and cannot be null");
            }
            else
            {
                this.Symbol = symbol;
