...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        public InlineResponse20012(List<Agent> data = default(List<Agent>), Meta meta = default(Meta))
        {
            ...
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for InlineResponse20012 and cannot be null");
            }
            else
            {
                this.Meta = meta;
