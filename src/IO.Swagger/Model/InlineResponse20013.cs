...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20013 :  IEquatable<InlineResponse20013>, IValidatableObject
    {
        ...
        public InlineResponse20013(List<Contract> data = default(List<Contract>), Meta meta = default(Meta))
        {
            ...
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for InlineResponse20013 and cannot be null");
            }
            else
            {
                this.Meta = meta;
