...
namespace IO.Swagger.Model
{
        ...
        public partial class Agent :  IEquatable<Agent>, IValidatableObject
    {
        ...
        public Agent(string accountId = default(string), string symbol = default(string), string headquarters = default(string), long? credits = default(long?), string startingFaction = default(string), int? shipCount = default(int?))
        {
            ...
            // to ensure "shipCount" is required (not null)
            if (shipCount == null)
            {
                throw new InvalidDataException("shipCount is a required property for Agent and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="startingFaction", EmitDefaultValue=false)]
