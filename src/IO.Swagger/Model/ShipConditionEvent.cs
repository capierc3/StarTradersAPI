...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ShipConditionEvent :  IEquatable<ShipConditionEvent>, IValidatableObject
    {
        /// <summary>
        /// Defines Symbol
        /// </summary>
        ...
        public ShipConditionEvent(SymbolEnum symbol = default(SymbolEnum), ComponentEnum component = default(ComponentEnum), string name = default(string), string description = default(string))
        {
            ...
            if (symbol == null)
            {
                throw new InvalidDataException("symbol is a required property for ShipConditionEvent and cannot be null");
            }
            else
            {
                this.Symbol = symbol;
            ...
            if (component == null)
            {
                throw new InvalidDataException("component is a required property for ShipConditionEvent and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ShipConditionEvent and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for ShipConditionEvent and cannot be null");
            }
            else
            {
