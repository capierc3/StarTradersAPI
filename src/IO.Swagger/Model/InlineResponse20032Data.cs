...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20032Data :  IEquatable<InlineResponse20032Data>, IValidatableObject
    {
        ...
        public InlineResponse20032Data(Agent agent = default(Agent), Ship ship = default(Ship), RepairTransaction transaction = default(RepairTransaction))
        {
            // to ensure "agent" is required (not null)
            if (agent == null)
            {
                throw new InvalidDataException("agent is a required property for InlineResponse20032Data and cannot be null");
            }
            else
            {
                this.Agent = agent;
            ...
            if (ship == null)
            {
                throw new InvalidDataException("ship is a required property for InlineResponse20032Data and cannot be null");
            }
            else
            {
                this.Ship = ship;
            ...
            if (transaction == null)
            {
                throw new InvalidDataException("transaction is a required property for InlineResponse20032Data and cannot be null");
            }
            else
            {
