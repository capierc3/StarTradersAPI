...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScrapTransaction :  IEquatable<ScrapTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrapTransaction" /> class.
        /// </summary>
        ...
        public ScrapTransaction(string waypointSymbol = default(string), string shipSymbol = default(string), int? totalPrice = default(int?), DateTime? timestamp = default(DateTime?))
        {
            // to ensure "waypointSymbol" is required (not null)
            if (waypointSymbol == null)
            {
                throw new InvalidDataException("waypointSymbol is a required property for ScrapTransaction and cannot be null");
            }
            else
            {
            ...
            if (shipSymbol == null)
            {
                throw new InvalidDataException("shipSymbol is a required property for ScrapTransaction and cannot be null");
            }
            else
            {
            ...
            if (totalPrice == null)
            {
                throw new InvalidDataException("totalPrice is a required property for ScrapTransaction and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for ScrapTransaction and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScrapTransaction {\n");
        ...
        {
            return this.Equals(input as ScrapTransaction);
        }

        /// <summary>
        /// Returns true if ScrapTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of ScrapTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScrapTransaction input)
        {
            if (input == null)
                return false;
