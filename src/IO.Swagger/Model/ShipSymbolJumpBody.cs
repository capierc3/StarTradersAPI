...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ShipSymbolJumpBody :  IEquatable<ShipSymbolJumpBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipSymbolJumpBody" /> class.
        /// </summary>
        ...
        public ShipSymbolJumpBody(string waypointSymbol = default(string))
        {
            // to ensure "waypointSymbol" is required (not null)
            if (waypointSymbol == null)
            {
                throw new InvalidDataException("waypointSymbol is a required property for ShipSymbolJumpBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipSymbolJumpBody {\n");
        ...
        {
            return this.Equals(input as ShipSymbolJumpBody);
        }

        /// <summary>
        /// Returns true if ShipSymbolJumpBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipSymbolJumpBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipSymbolJumpBody input)
        {
            if (input == null)
                return false;
