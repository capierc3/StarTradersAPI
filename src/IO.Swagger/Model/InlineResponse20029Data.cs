...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20029Data :  IEquatable<InlineResponse20029Data>, IValidatableObject
    {
        ...
        public InlineResponse20029Data(ScrapTransaction transaction = default(ScrapTransaction))
        {
            // to ensure "transaction" is required (not null)
            if (transaction == null)
            {
                throw new InvalidDataException("transaction is a required property for InlineResponse20029Data and cannot be null");
            }
            else
            {
