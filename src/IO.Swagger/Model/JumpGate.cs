...
namespace IO.Swagger.Model
{
        ...
        public partial class JumpGate :  IEquatable<JumpGate>, IValidatableObject
    {
        ...
        public JumpGate(string symbol = default(string), List<string> connections = default(List<string>))
        {
            ...
            if (symbol == null)
            {
                throw new InvalidDataException("symbol is a required property for JumpGate and cannot be null");
            }
            else
            {
                this.Symbol = symbol;
            ...
            if (connections == null)
            {
                throw new InvalidDataException("connections is a required property for JumpGate and cannot be null");
            }
            else
            {
