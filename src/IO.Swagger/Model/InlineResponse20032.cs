...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20032 :  IEquatable<InlineResponse20032>, IValidatableObject
    {
        ...
        public InlineResponse20032(InlineResponse20032Data data = default(InlineResponse20032Data))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20032 and cannot be null");
            }
            else
            {
                this.Data = data;
